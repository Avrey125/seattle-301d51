...
function displayPics(){
  ...
  // beacuse const is only used in the block level, it returns undefined beacuse console.log(rando) is being called outside the function
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${allProducts[i].name}  has   ${allProducts[i].views} votes in ${allProducts[i].views}  views`;
