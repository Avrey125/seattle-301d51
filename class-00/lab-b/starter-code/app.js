...
//  There is no this when using an arrow function, it refers to the enclosing scope/window
// 3. Explain why "this" is different when an arrow function is used.
// arrow functions cannot be used in constructors, arrow functions have no 'this'
